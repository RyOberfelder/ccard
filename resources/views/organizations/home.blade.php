...
<!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li {{ Request::is( 'home/organizations/users') ? 'class=sidebar-nav-li-active' : '' }}><a href="/home/organizations/users">Users</a></li>
                ...
                <li {{ Request::is( 'home/organizations/connections') ? 'class=sidebar-nav-li-active' : '' }}><a href="/home/organizations/connections">Connections</a></li>
